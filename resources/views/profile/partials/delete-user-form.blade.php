...
<!-- Modal -->
<div id="deleteAccountModal" class="modal fade" tabindex="-1" aria-labelledby="deleteAccountModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 id="deleteAccountModalLabel" class="modal-title fs-5">
            ...
            <div class="modal-body">
                ...
                <form id="deleteAccountForm" class="p-6" method="post" action="{{ route('profile.destroy') }}">
                    @csrf
                    @method('delete')
